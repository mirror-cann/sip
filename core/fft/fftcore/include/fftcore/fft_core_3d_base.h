...
#ifndef __FFTCORE_3D_BASE__
#define __FFTCORE_3D_BASE__
...
class FftCore3DBase : public FftOperation {
public:
    FftCore3DBase(FFTCoreType core_type, unsigned fftX, unsigned fftY, unsigned fftZ, unsigned batchSize,
                  AsdSip::asdFftType fft_type, bool forward)
        : problemDesc{fftX, fftY, fftZ, batchSize, fft_type, forward},
          coreType(core_type)
    {
    }
    bool init() override
