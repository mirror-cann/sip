...
- 计算公式：
  ...
  $$
        ...
        输入“x”为：
        [1+2i, 2-2i, -3+3i, 4-3i]
        调用asdBlasScasum算子后，输出“result”为：
        20
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>x（aclTensor *）</td>
      <td>输入</td>
      <td><ul><li>表示输入的向量，对应公式中的'x'。</li><li>asdBlasScasum支持的数据类型为COMPLEX64。</li><li>asdBlasSasum支持的数据类型为FLOAT32。</li><li>数据格式支持ND。</li><li>shape为[n]。</li></ul></td>
    </tr>
    <tr>
      <td>incx（int64_t）</td>
      <td>输入</td>
