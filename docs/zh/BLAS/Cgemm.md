...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>A（aclTensor *）</td>
      <td>输入</td>
      <td><ul><li>输入的矩阵，对应公式中的'A'</li><li>数据类型支持COMPLEX64。</li><li>数据格式支持ND。</li><li>shape为[m，k]。</li></ul></td>
      <td>COMPLEX64</td>
      <td>ND</td>
      <td>[m，k]</td>
    </tr>
    <tr>
      ...
      <td>输入</td>
      <td>算子的句柄</td>
      <td><ul><li>输入的矩阵，对应公式中的'B'</li><li>数据类型支持COMPLEX64。</li><li>数据格式支持ND。</li><li>shape为[k，n]。</li></ul></td>
      <td>ND</td>
      <td>[k，n]</td>
    </tr>
    <tr>
      <td>C（aclTensor *）</td>
      <td>输入</td>
      <td><ul><li>输入的矩阵，对应公式中的'c'</li><li>数据类型支持COMPLEX64。</li><li>数据格式支持ND。</li><li>shape为[m，n]。</li></ul></td>
      <td>COMPLEX64</td>
      <td>ND</td>
      <td>[m，n]</td>
    </tr>
