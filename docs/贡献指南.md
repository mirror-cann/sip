## 了解行为准则
SiP属于CANN开放项目，在参与贡献前，请了解[CANN开放项目行为准则](context/code-of-conduct.md)，后续您在SiP项目的活动（包括但不限于发表评论、提交Issue、发表wiki等）都请遵循此行为准则。
...
所有您发现的问题或想贡献的新想法都可以通过[Issue](#提交Issue处理Issue任务)进行反馈、讨论和跟踪，并在后续[贡献编码](#贡献编码) Pull-Request 合入后关闭关联Issue。

> 📝 **提示**
>
> - 当您在提交PR过程中遇到问题，常见问题的解决方法可参见[FAQs](context/infra-faqs.md)。
...
- 提交Issue
  ...
  如果您准备向社区上报Bug或者提交需求，或者为社区贡献自己的意见或建议，请提交Issue(https://gitcode.com/cann/sip/issues)。
...
![代码贡献流程](images/contrib-flow.png)  
   ...
   (4) 请注意查看门禁测试结果，若未通过，请根据问题提示进行本地代码修改；若通过，此PR会被分配给committer检视，请关注commiter的检视意见。  
