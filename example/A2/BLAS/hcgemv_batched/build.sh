...
echo "Execute the example of HcgemvBatchedOperation, performing batched complex matrix-vector multiplication with Hermitian matrices:"
./example
rm example