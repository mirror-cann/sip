...
## 介绍
该目录下为信号加速库FFT1DOperation C++调用示例。

## 功能说明

- 算子功能：执行带batch的1D快速傅里叶变换。
- 计算公式：
    $$
...
- **example_acl_fft_c2r_1d.cpp**
    ...
    【注】：编译脚本内替换 example_acl_fft_c2c_1d.cpp 为 example_acl_fft_c2r_1d.cpp 可编译运行。
    ...
    **输出**
    | TensorName |  DataType  | DataFormat |      Shape      |       Value     |
    | :--------: | :--------: | :--------: | :-------------: | :-------------: |
    |     out    |   flot32   |     nd     |  [batch, Nfft]  |         -       |

     ---

- **example_acl_fft_r2c_1d.cpp**

    【注】：编译脚本内替换 example_acl_fft_c2c_1d.cpp 为 example_acl_fft_r2c_1d.cpp 可编译运行。
