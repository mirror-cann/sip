...
AsdSip::AspbStatus Nrm2Tiling(const LaunchParam &launchParam, KernelInfo &kernelInfo)
{
    ...
    OpParam::Nrm2 param = AnyCast<OpParam::Nrm2>(launchParam.GetParam());
