...
at::Tensor CscalGolden(std::complex<float> alpha, at::Tensor x)
{
    at::Tensor golden;
...
TEST(TestOpCscal, TestCscalF32)
{
    ...
    at::Tensor golden = CscalGolden(alpha, atX);
    ...
    AspbStatus blasStatus = asdBlasCscal(handle, n, alpha, aclX, incx);
