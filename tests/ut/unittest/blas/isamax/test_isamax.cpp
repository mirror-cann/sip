...
at::Tensor IsamaxGolden(at::Tensor x)
{
    at::Tensor golden;
    golden = at::argmax(torch::abs(x), false) + 1;
...
TEST(TestOpIsamax, TestIsamaxF32)
{
    int64_t n = 16;
    int64_t incx = 1;
    ...
    at::Tensor golden = IsamaxGolden(atX);
    ...
    AspbStatus blasStatus = asdBlasIsamax(handle, n, aclX, incx, aclOut);
