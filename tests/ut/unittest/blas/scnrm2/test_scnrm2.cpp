...
at::Tensor Scnrm2Golden(at::Tensor x)
{
    at::Tensor golden;
    golden = at::norm(x);
    return golden;
...
TEST(TestOpScnrm2, TestScnrm2F32)
{
    int64_t n = 16;
    int64_t incx = 1;
    ...
    at::Tensor golden = Scnrm2Golden(atX);
    ...
    AspbStatus blasStatus = asdBlasScnrm2(handle, n, aclX, incx, aclY);
