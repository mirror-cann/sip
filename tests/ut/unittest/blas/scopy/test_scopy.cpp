...
at::Tensor ScopyGolden(at::Tensor x)
{
    at::Tensor golden;
    golden = x;
    return golden;
...
bool RunScopy(struct ScopyUTParam param, bool set_plan_handle_null=false)
{
    int64_t n = param.n;
    ...
    status = asdBlasScopy(handle, n, aclX, incx, aclY, incy);
    ...
    at::Tensor golden = ScopyGolden(atX);

    void *inputYDeviceAddr = Mki::GetStorageAddr(aclY);
    aclrtMemcpy(y.hostData, n * sizeof(float), inputYDeviceAddr, n * sizeof(float), ACL_MEMCPY_DEVICE_TO_HOST);
...
TEST(TestOpScopy, TestScopyF32)
{
    ...
    ASSERT_EQ(RunScopy({inTensorDescs, n, incx, incy}), true);
}


TEST(TestOpScopy, TestScopyF32LongDims)
{
    int64_t n = 1024;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpScopy, TestScopyF32Not32)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpScopy, TestScopyF32InOutSizeNotEqualX)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
    ...
    ASSERT_EQ(RunScopy({inTensorDescs, n, incx, incy}), false);
}


TEST(TestOpScopy, TestScopyF32InOutSizeNotEqualY)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpScopy, TestScopyF32InOutDtypeNotEqualX)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpScopy, TestScopyF32InOutDtypeNotEqualY)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpScopy, TestScopyF32InvalidIncx)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = -1;
    int64_t incy = 1;
...
TEST(TestOpScopy, TestScopyF32InvalidIncy)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = -1;
...
TEST(TestOpScopy, TestScopyF32NoneHandle)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
    ...
    ASSERT_EQ(RunScopy({inTensorDescs, n, incx, incy}, true), false);
}
