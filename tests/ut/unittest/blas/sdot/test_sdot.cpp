...
at::Tensor SdotGolden(at::Tensor x, at::Tensor y)
{
    at::Tensor golden;
    golden = at::dot(x, y);
    return golden;
...
bool RunSdotc(struct SdotcUTParam param, bool set_plan_handle_null=false)
{
    int64_t n = param.n;
    ...
    status = asdBlasSdot(handle, n, aclX, incx, aclY, incy, aclResult);
    ...
    at::Tensor atY = at::from_blob(y.hostData, ToIntArrayRef(y.desc.dims), at::kFloat);

    at::Tensor golden = SdotGolden(atX, atY);
    ...
    at::Tensor ret = at::from_blob(result.hostData, ToIntArrayRef(result.desc.dims), at::kFloat);
...
TEST(TestOpSdot, TestSdotF32)
{
    ...
    ASSERT_EQ(RunSdotc({inTensorDescs, n, incx, incy}), true);
}


TEST(TestOpSdot, TestSdotF32LongDims)
{
    int64_t n = 1024;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32Not32)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32InSizeNotEqualX)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
    ...
    Status status;
    SVector<TensorDesc> inTensorDescs;
    inTensorDescs.push_back({TENSOR_DTYPE_FLOAT, TENSOR_FORMAT_ND, {n + 15}});
    inTensorDescs.push_back({TENSOR_DTYPE_FLOAT, TENSOR_FORMAT_ND, {n}});
    inTensorDescs.push_back({TENSOR_DTYPE_FLOAT, TENSOR_FORMAT_ND, {1}});
    aclTensorContext context;

    ASSERT_EQ(RunSdotc({inTensorDescs, n, incx, incy}), false);
}


TEST(TestOpSdot, TestSdotF32InSizeNotEqualY)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32OutSizeNotOne)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32DtypeNotEqualX)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32DtypeNotEqualY)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32DtypeNotEqualRes)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32InvalidIncx)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = -1;
    int64_t incy = 1;
...
TEST(TestOpSdot, TestSdotF32InvalidIncy)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = -1;
...
TEST(TestOpSdot, TestSdotF32NullHandle)
{
    int64_t n = 32 * 12 + 3;
    int64_t incx = 1;
    int64_t incy = 1;
    ...
    ASSERT_EQ(RunSdotc({inTensorDescs, n, incx, incy}, true), false);
}